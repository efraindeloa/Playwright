...
const IMAGE_TRANSPARENT_PATH = process.env.IMAGE_TRANSPARENT_PATH || 'C:/Temp/transparent.png';
...
test.describe('Gestión de promociones en producción', () => {
  ...
  test('editar promoción', async ({ page }) => {
    ...
    // Buscar cualquier promoción que contenga el prefijo de prueba
